...
from authentication.views import LogoutAPIView, RegisterView, SetNewPasswordAPIView, VerifyEmail, LoginView, PasswordTokenCheckAPIView, RequestPasswordResetEmailAPIView
